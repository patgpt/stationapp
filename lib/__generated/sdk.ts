...
export enum AssetLinkingCollectionsComponentAuthorCollectionOrder {
...
export enum AssetLinkingCollectionsComponentRichImageCollectionOrder {
...
export enum AssetLinkingCollectionsComponentSeoCollectionOrder {
...
export enum AssetLinkingCollectionsPageBlogPostCollectionOrder {
  InternalNameAsc = 'internalName_ASC',
  InternalNameDesc = 'internalName_DESC',
...
/** To have author-related properties [See type definition](https://app.contentful.com/spaces/mh4i0rpgguui/content_types/componentAuthor) */
...
/** To describe an image used in rich text fields [See type definition](https://app.contentful.com/spaces/mh4i0rpgguui/content_types/componentRichImage) */
...
/** To have SEO-related properties to the pages we render [See type definition](https://app.contentful.com/spaces/mh4i0rpgguui/content_types/componentSeo) */
...
/** To create individual blog posts [See type definition](https://app.contentful.com/spaces/mh4i0rpgguui/content_types/pageBlogPost) */
...
/** To have an entry point for the app (e.g. Homepage) [See type definition](https://app.contentful.com/spaces/mh4i0rpgguui/content_types/pageLanding) */
